...
# GV07：Audit、Accountability and Data Governance

## 它解决什么问题

复杂 Agent 的决定、数据流和责任若只留在聊天中，无法解释、纠错或满足治理。

## 核心定义

Audit Trail 记录谁在何时基于什么版本执行何动作；Accountability 指定结果与审批责任；Data Governance 管理分类、用途、保留、删除和共享。
...
~~~text
Architecture View
Identity/events/data lineage -> immutable audit -> review/redress
~~~
...
日志记录敏感 Prompt 又无限保留会制造新风险；审计最小化、分级访问与 TTL。
...
企业、高风险和跨系统 Agent。使高价值自动化能够在可接受风险下上线。
